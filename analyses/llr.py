'''This file was taken from the GitHub of Ted Dunning, creator of the log-
...
def llr_root(k11, k12, k21, k22):
    ...
    bad_variable_name1 = float(k11) / (k11 + k12)
    bad_variable_name2 = float(row) / total
    sign = (bad_variable_name1 > bad_variable_name2) - (bad_variable_name1 < bad_variable_name2)
