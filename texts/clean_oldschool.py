...
def main(path, new_path):
    ...
    text = text[text.index('The publisher of the Port Folio'):text.index('MISS SOMEDAY.')] + text[text.index('In removing an artificial mound in Chilicothe'):]
...
if __name__ == '__main__':
    main('raw/oldschool.txt', 'clean/oldschool.txt')
